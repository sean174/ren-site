...
1. If the account has an "online tool"—like Facebook's Legacy Contact feature or Google's Inactive Account Manager—that designates who receives access after death, that designation controls.
2. If no online tool exists, the terms of service and estate planning documents (will or trust) govern access.
3. If neither applies, state law applies.
